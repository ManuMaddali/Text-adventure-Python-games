...
class Fighter(Character):
    def __init__(self):
        super().__init__(name=input("Enter fighter name: "),thaco=20,ac=10,
...
class cleric(Character):
    def __init__(self):
        super().__init__(name=input("Enter Cleric name: "),thaco=20,ac=10,
...
class Mage(Character):
    def __init__(self):
        super().__init__(name=input("Enter Mage name: "),thaco=20,ac=10,
